...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/inSave.action"
		method=post >
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：账务管理 &gt; 添加收入</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="inMoney">
								</td>
								<td>收入类别 ：</td>
								<td>
							...
							<TR>
								...
								<INPUT class=textbox id=in_time
														style="WIDTH: 180px" maxLength=50 name="inTime">
								</td>
								<td>备注 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="inMemo">
								</td>
							<tr>
								<td rowspan=2>
