...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/turnFindAll.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：账务管理 &gt; 转账列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${pageBean.list}" var="turnVo">
												
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${turnVo.turnTime}</TD>
													<TD>${turnVo.kind_item}</TD>
													<TD>${turnVo.turnMoney}</TD>
													<TD>${turnVo.turnMemo}</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/turnEdit.action?turnId=${turnVo.turnId}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/turnDelete.action?turnId=${turnVo.turnId}">删除</a>
													</TD>
												</TR>
									      </c:forEach>
											</TBODY>
