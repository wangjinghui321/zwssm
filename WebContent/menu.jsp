							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 支出管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/paySaveUI.action" 
														target=main>－ 新增支出</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/payFindAll.action"
														target=main>－ 支出列表</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 收入管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/inSaveUI.action"
														target=main>－ 新增收入</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/inFindAll.action"
														target=main>－收入列表</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> 转账管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/turnSaveUI.action"
														target=main>－新增转账</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${ pageContext.request.contextPath }/turnFindAll.action"
														target=main>－转账列表</A></TD>
												</TR>
