		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				<TR>
					...
					<TD background=images/new_002.jpg><FONT size=5><B>记账系统v1.0</B></FONT></TD>
							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="${pageContext.request.contextPath}/logout.action" target=_top><FONT color=red>安全退出</FONT></A>
									</TD>
								</TR>
							</TBODY>
						</TABLE>
